...
def on_message(ws, message):
    ...
    try:
        ...
        if msg_type == "Begin":
            ...
            # Lógica mejorada para imprimir el texto en tiempo real.
            if formatted:
                # Si el texto es final, borra la línea anterior y lo imprime en una nueva.
                print(' ' * 80, end='\r')
                print(transcript)
            else:
                # Si es parcial, lo imprime y regresa el cursor al inicio
                # para que el siguiente texto lo sobreescriba.
